...
public enum ErrorCode {
    ...
    TICKET_PRODUCT_STATUS_TRANSITION_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "허용되지 않는 판매 상태 전환입니다."),
    ...
    BOOTH_PRODUCT_CREATION_NOT_ALLOWED(
            HttpStatus.CONFLICT, "마감·취소·보관된 모집공고에는 새 부스 상품을 등록할 수 없습니다."),
    ...
    APPLICATION_PERIOD_EXCEEDS_EVENT_PERIOD(
            HttpStatus.BAD_REQUEST, "신청 종료 일시는 행사 시작 일시보다 늦을 수 없습니다."),
    ...
    RECRUITMENT_NOTICE_NOT_OPEN(HttpStatus.CONFLICT, "게시 중인 모집공고에서만 처리할 수 있습니다."),
