 ...
 * <p>Service의 {@link InvalidPhoneNumberException}과 요청 DTO {@code @Valid} 실패를 {@link
 * AuthApiResponse} 공통 형식으로 변환해 400 Bad Request 로 응답한다.
...
public class PhoneVerificationExceptionHandler {
     ...
     * <p>{@link com.expo.auth.service.PhoneVerificationService#normalize(String)} 에서 null·빈 값·010 형식
     * 불일치 시 던진다. 응답 예: {@code { "success": false, "data": null, "message": "휴대폰 번호 형식이 올바르지 않습니다." }}
     ...
     *
     * <p>{@code @NotBlank}, {@code @Pattern} 등이 실패하면 Spring이 {@link MethodArgumentNotValidException}을
     * 던진다. 필드별 메시지를 쉼표로 이어 하나의 문자열로 반환한다.
