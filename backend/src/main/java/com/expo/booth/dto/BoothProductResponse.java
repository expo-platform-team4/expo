...
public record BoothProductResponse(
        ...
        @Schema(description = "전시관(홀) ID") Long venueHallId,
        @Schema(description = "전시관(홀) 이름") String venueHallName,
        @Schema(description = "구역(홀) ID") Long venueZoneId,
        @Schema(description = "구역(홀) 이름") String venueZoneName,
